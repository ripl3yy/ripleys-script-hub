...
case $CHOICE in
    ...
    2 )
      ...
      echo "#########################################"
            sleep .5
            flatpak install flathub com.spotify.Client com.github.tchx84.Flatseal io.github.alainm23.planify md.obsidian.Obsidian com.heroicgameslauncher.hgl com.github.unrud.VideoDownloader org.vinegarhq.Vinegar net.davidotek.pupgui2 net.agalwood.Motrix
            sleep 1
      echo "###########################################"
      echo "  Done! Make sure to restart your system!  "
      echo "###########################################"
